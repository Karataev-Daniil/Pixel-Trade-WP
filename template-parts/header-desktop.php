                ...
                <nav class="header-bottom" aria-label="<?= t('Навигационное меню', 'Navigation Menu', 'Meniu de navigare'); ?>">  
                    ...
                    <form role="search" method="get" class="search-form search-panel has-content" action="<?= esc_url(home_url('/search-products/')); ?>">
                        <div class="search-wrapper">
                            <button type="submit" class="search-icon-button primary-button-small" aria-label="<?= t('Поиск', 'Search', 'Caută'); ?>" disabled>
                                <?= file_get_contents(get_template_directory() . '/images/icon-search.svg'); ?>
                            </button>

                            <input id="search-field" 
                                   class="search-field body-medium-regular"
                                   placeholder="<?= esc_attr(t('Поиск объявлений', 'Search listings', 'Caută anunțuri')); ?>"
                                   value="" 
                                   name="q"
                                   autocomplete="off" />
                            ...
                            <button 
                                ...
                                aria-label="<?= t('Очистить поиск', 'Clear search', 'Șterge căutarea'); ?>">
                            </button>

                        </div>

                        <ul id="search-suggestions" class="search-suggestions">
                            <li id="loader-template" class="loader-box" style="display:none">
