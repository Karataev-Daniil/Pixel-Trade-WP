...
//     function generateFieldName(key) {
...
//         if (fieldData.type === 'select' && fieldData.options && fieldData.options.length) {
//             input = document.createElement('select');
//             input.name = fieldName;
//             input.classList.add('category-select', 'select-tertiary', 'body-small-regular');
...
//             span.textContent = ' ' + fieldData.suffix;
//             span.classList.add('category-suffix', 'label-medium');
//             wrapperDiv.appendChild(input);
...
//             Object.entries(categoryFields).forEach(([groupKey, groupData]) => {
//                 const groupLabel = groupData.label?.[categorySelectorVars.language] || groupData.label?.ru || groupKey;

//                 const groupWrapper = document.createElement('fieldset');
//                 groupWrapper.classList.add('dynamic-fields__group');

//                 const div = document.createElement('div');
//                 div.classList.add('dynamic-fields__group-title', 'label-medium');
//                 div.textContent = groupLabel;
//                 groupWrapper.appendChild(div);
            
//                 Object.entries(groupData).forEach(([fieldKey, fieldData]) => {
//                     if (fieldKey === 'label') return;
//                     const field = createDynamicField(fieldKey, fieldData);
//                     groupWrapper.appendChild(field);
//                 });
            
//                 dynamicFieldsContainer.appendChild(groupWrapper);
//             });
//         });
//     }
